...
public class MyPanel extends JPanel implements Runnable {
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("医院", Hospital.getInstance().getX() + Hospital.getInstance().getWidth() / 4 - 10, Hospital.getInstance().getY() - 16);
        //绘制代表人类的圆点
        ...
        for (Person person : people) {
            ...
            if (worldTime % 10 == 0 && worldTime <= 140 ){

            PersonPool.getInstance().enterperson();
            }
